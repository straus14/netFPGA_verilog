...
*/
				  ...
				  case(dst_mac)
						...
						default:
							...
							if(prj_counter_dst < 4)
								 if(prj_counter_dst == 3)
								 	   prj_mac_dst4 = dst_mac;
								       prj_mac_dst4_cnt = 1;
								       prj_counter_dst = prj_counter_dst +1;
								 end
								 if(prj_counter_dst == 2)
								 	   prj_mac_dst3 = dst_mac;
								       prj_mac_dst3_cnt = 1;
								       prj_counter_dst = prj_counter_dst +1;
								 end
								 if (prj_counter_dst == 1)
						              prj_mac_dst2 = dst_mac;
								      prj_mac_dst2_cnt = 1;
								      prj_counter_dst = prj_counter_dst +1;
								 end
								 if (prj_counter_dst == 0)
